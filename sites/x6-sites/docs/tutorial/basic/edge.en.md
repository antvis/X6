...
Both nodes and edges share a common base class [Cell](/en/docs/api/model/cell). In addition to inheriting properties from `Cell`, edges support the following options.
...
| labels         | Label[]            | -                                              | Labels.              |
| defaultLabel   | Label              | [Default Label](/en/docs/api/model/labels#default-label) | Default label.       |
