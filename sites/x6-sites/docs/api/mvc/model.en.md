...
| Name         | Type | Required | Default | Description                                                                                                                   |
|--------------|------|:--------:|---------|-------------------------------------------------------------------------------------------------------------------------------|
| options.deep | diff |          | `false` | Whether to export differential data of nodes and edges (parts that differ from the [default configuration](/api/model/cell#default-options) of nodes and edges). |
