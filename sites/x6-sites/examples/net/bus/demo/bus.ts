...
class Connector extends Shape.Edge {
...
class Component extends Shape.Rect {
  static create(
    x: number,
    y: number,
    width: number,
...
var component6 = Component.create(100, 130, 150, 40, 'Input Channel').addPort({
  group: 'in',
})
