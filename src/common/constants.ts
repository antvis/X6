...
export const constants = {
  ...
  TRANSPARENT_IMG: 'data:image/gif;base64,R0lGODlhMAAwAIAAAP///wAAACH5BAEAAAAALAAAAAAwADAAAAIxhI+py+0Po5y02ouz3rz7D4biSJbmiabqyrbuC8fyTNf2jef6zvf+DwwKh8Si8egpAAA7',
   ...
   */
  PAGE_FORMAT_A4_PORTRAIT: new Rectangle(0, 0, 827, 1169),
   ...
   * of this page format are 826x1169 pixels.
   */
  PAGE_FORMAT_A4_LANDSCAPE: new Rectangle(0, 0, 1169, 827),
