...
export namespace JSONExt {
   ...
   * @returns `true` if the values are equivalent, `false` otherwise.
   */
  export function deepArrayEqual(first: ReadonlyJSONArray, second: ReadonlyJSONArray): boolean {
   ...
   * @returns `true` if the values are equivalent, `false` otherwise.
   */
  export function deepObjectEqual(first: ReadonlyJSONObject, second: ReadonlyJSONObject): boolean {
    // Check referential equality first.
    if (first === second) {
      return true
    }
   ...
   * @returns A deep copy of the given JSON value.
   */
  export function deepArrayCopy(value: any): any {
    const result: any = []
   ...
   * @returns A deep copy of the given JSON value.
   */
  export function deepObjectCopy(value: any): any {
    const result: any = {}
