...
export class Text extends Shape {
   ...
   */
  redraw() {
    if (this.visible && this.isValidBounds() && this.cacheEnabled && this.lastValue == this.value &&
  ...
  updateValue() {
    if (mxUtils.isNode(this.value)) {
      ...
      if (this.overflow == 'fill' || this.overflow == 'width') {
        ...
        const lh = (mxConstants.ABSOLUTE_LINE_HEIGHT) ? (this.size * mxConstants.LINE_HEIGHT) + 'px' :
