...
export class Scroller extends View {
  ...
  public backgroundManager: Scroller.Background
  ...
  constructor(options: Scroller.Options) {
    super()
    this.options = Scroller.getOptions(options)
    CSSManager.ensure()
  }
  ...
  initDom() {
    ...
    Dom.addClass(this.container, this.prefixClassName(Scroller.containerClass))
    Dom.css(this.container, { width, height })

    if (this.options.pageVisible) {
      Dom.addClass(this.container, this.prefixClassName(Scroller.pagedClass))
    }
    ...
    Dom.addClass(this.content, this.prefixClassName(Scroller.contentClass))
    ...
    Dom.addClass(
      this.background,
      this.prefixClassName(Scroller.backgroundClass),
    )
  ...
  transitionToPoint(
    ...
    // Dom.addClass(this.container, Scroller.transitionClassName)
    // this.$content
    //   .off(Scroller.transitionEventName)
    //   .on(Scroller.transitionEventName, (e) => {
  ...
  protected removeTransition() {
    // todo
    // this.$container.removeClass(Scroller.transitionClassName)
    // this.$content.off(Scroller.transitionEventName).css({
    //   transform: '',
    //   transformOrigin: '',
    //   transition: '',
    //   transitionDuration: '',
