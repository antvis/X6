...
import { View, Markup, CellView } from '.'
...
export class GraphView extends View {
  ...
  protected onDblClick(evt: Dom.DoubleClickEvent) {
    ...
    const localPoint = this.renderer.snapToGrid(e.clientX, e.clientY)

    if (view) {
      view.onDblClick(e, localPoint.x, localPoint.y)
    } else {
      this.renderer.trigger('blank:dblclick', {
        e,
        x: localPoint.x,
        y: localPoint.y,
      })
  ...
  protected onClick(evt: Dom.ClickEvent) {
    if (this.getMouseMovedCount(evt) <= this.options.clickThreshold) {
      ...
      if (view) {
        ...
        this.renderer.trigger('blank:click', {
          e,
          x: localPoint.x,
          y: localPoint.y,
        })
  ...
  protected onContextMenu(evt: Dom.ContextMenuEvent) {
    ...
    if (view) {
      ...
      this.renderer.trigger('blank:contextmenu', {
        e,
        x: localPoint.x,
        y: localPoint.y,
      })
  ...
  protected onMouseDown(evt: Dom.MouseDownEvent) {
    ...
    if (view) {
      ...
      this.renderer.trigger('blank:mousedown', {
        e,
        x: localPoint.x,
        y: localPoint.y,
      })
  ...
  protected onMouseMove(evt: Dom.MouseMoveEvent) {
    ...
    if (view) {
      ...
      this.renderer.trigger('blank:mousemove', {
        e,
        x: localPoint.x,
        y: localPoint.y,
      })
  ...
  protected onMouseUp(e: Dom.MouseUpEvent) {
    ...
    const localPoint = this.renderer.snapToGrid(
      normalized.clientX,
      normalized.clientY,
    )
    const data = this.getEventData<EventData.Moving>(e)
    ...
    if (view) {
      ...
      this.renderer.trigger('blank:mouseup', {
        e: normalized,
        x: localPoint.x,
        y: localPoint.y,
      })
  ...
  protected onMouseOver(evt: Dom.MouseOverEvent) {
    ...
    if (view) {
      ...
      this.renderer.trigger('blank:mouseover', { e })
    }
  }
  ...
  protected onMouseOut(evt: Dom.MouseOutEvent) {
    ...
    if (view) {
      ...
      this.renderer.trigger('blank:mouseout', { e })
    }
  }
  ...
  protected onMouseEnter(evt: Dom.MouseEnterEvent) {
    ...
    const relatedView = this.renderer.findViewByElem(e.relatedTarget as Element)
    if (view) {
      if (relatedView === view) {
      ...
      this.renderer.trigger('graph:mouseenter', { e })
    }
  }
  ...
  protected onMouseLeave(evt: Dom.MouseLeaveEvent) {
    ...
    if (view) {
      ...
      this.renderer.trigger('graph:mouseleave', { e })
    }
  }
  ...
  protected onMouseWheel(evt: Dom.EventObject) {
    ...
    if (view) {
      ...
      this.renderer.trigger('blank:mousewheel', {
        e,
        delta,
        x: localPoint.x,
        y: localPoint.y,
