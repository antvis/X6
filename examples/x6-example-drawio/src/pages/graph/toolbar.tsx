...
> {
  ...
  renderColorPicker(
    ...
    return (
      <Menu hasIcon={false}>
        <MenuItem name={name}>
          <SketchPicker width="220px" color={value} onChange={onChange} />
        </MenuItem>
      </Menu>
    )
  }
  ...
  render() {
    ...
    return (
      <Toolbar hoverEffect={true} onClick={this.handleClick}>
        <Group>
          <Item
            name="zoom"
            tooltipAsTitle={true}
        ...
        <Group>
          <Item
            ...
            icon={<Icon type={Icons.undo} svg={true} />}
          />
          <Item
            name="redo"
            tooltip="Redo (Cmd + Shift + Z)"
            disabled={!this.state.canRedo}
            icon={<Icon type={Icons.redo} svg={true} />}
          />
        </Group>
        <Group>
          <Item
            ...
            icon={<Icon type={Icons.del} svg={true} />}
          />
        </Group>
        <Group>
          <Item
            ...
            disabled={!hasSelectedCell}
            icon={<Icon type={Icons.toFront} svg={true} />}
          />
          <Item
            name="toBack"
            tooltip="To Back (Cmd + Shift + B)"
            disabled={!hasSelectedCell}
            icon={<Icon type={Icons.toBack} svg={true} />}
          />
        </Group>
        <Group>
          <Item
          ...
          <Item
            ...
            tooltip="Shadow"
            disabled={!hasSelectedCell}
            icon={<Icon type={Icons.shadow} svg={true} />}
          />
        </Group>
      </Toolbar>
    )
