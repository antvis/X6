...
export class Commands {
  ...
  add(cmd: Command | Command.Options): Command {
    const result = cmd instanceof Command ? cmd : new Command(cmd)
...
export namespace Commands {
  ...
  const list: Command.Options[] = [
...

    {
      name: 'undo',
      shortcut: `${ctrlKey}+Z`,
      handler: (graph: Graph, undoManager: UndoManager) => {
        undoManager.undo()
      },
    },
    {
    ...
    {
      name: 'strokeWidth',
      handler: (graph: Graph, strokeWidth?: number) =>
        graph.updateCellsStyle('strokeWidth', strokeWidth),
    },
    {
      name: 'strokeDashed',
    ...
    {
      name: 'fontFamily',
      handler: (graph: Graph, fontFamily?: string) =>
        graph.updateCellsStyle('fontFamily', fontFamily),
    },
    {
      name: 'fontColor',
    ...
    },
    {
      ...
      handler: (graph: Graph, color?: string) =>
        graph.updateCellsStyle('labelBackgroundColor', color),
    },
    {
      name: 'align',
    ...
    {
      name: 'horizontal',
      handler: (graph: Graph, horizontal?: boolean) =>
        graph.updateCellsStyle('horizontal', horizontal),
    },
    {
      name: 'labelPosition',
