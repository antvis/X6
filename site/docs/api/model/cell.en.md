...
Set attribute values through the attribute object, and perform a [deep merge](https://lodash.com/docs/4.18.1#_mergeobject-sources) with the existing attribute object.
...
By default, it performs a [deep merge](https://lodash.com/docs/4.18.1#_mergeobject-sources) with the original data and triggers the `change:data` event and canvas redraw:
