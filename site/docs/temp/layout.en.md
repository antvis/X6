...
- Choose a layout type, such as the `grid` above. If you are unsure which layout to use, you can check the examples [here](https://g6.antv.antgroup.com/en/examples#layout-grid) for visual references. You can refer to the corresponding documentation for layout configurations.
